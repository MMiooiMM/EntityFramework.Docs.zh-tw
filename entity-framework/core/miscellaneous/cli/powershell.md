...
| 參數                 | 描述                                                                                                                                                                                                          |
|:--------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| -Context \<String>        | 要使用的 `DbContext` 類別。 只有或與命名空間完整限定的類別名稱。  如果省略這個參數時，EF Core 會尋找內容類別。 如果有多個內容類別，這是必要參數。 |
| -Project \<String>        | 目標專案。 如果省略這個參數，則**預設專案**for **Package Manager Console**做為目標的專案。                                                                             |
| -StartupProject \<String> | 啟始專案。 如果省略這個參數，則**啟始專案**中**方案屬性**做為目標的專案。                                                                                 |
| -Verbose                  | 顯示詳細資訊輸出。                                                                                                                                                                                                 |
...
| 參數                         | 描述                                                                                                             |
|:----------------------------------|:------------------------------------------------------------------------------------------------------------------------|
| <nobr>-Name \<String><nobr>       | 移轉名稱。 這是位置參數，而且為必要。                                              |
| <nobr>-OutputDir \<String></nobr> | 目錄 （及子命名空間） 使用。 路徑是相對於目標的專案目錄。 預設為 「 移轉 」。 |
...
| <nobr>-Provider \<String></nobr>   | 要使用提供者 通常這是 NuGet 套件的名稱，例如： `Microsoft.EntityFrameworkCore.SqlServer`。 這是位置參數，而且為必要。                                                                                           |
| -OutputDir \<String>               | 將檔案放入目錄。 路徑是相對於專案目錄。                                                                                                                                                                                             |
| -ContextDir \<String>              | 將目錄`DbContext`檔案中。 路徑是相對於專案目錄。                                                                                                                                                                              |
| -Context \<String>                 | 名稱`DbContext`類別來產生。                                                                                                                                                                                                                          |
| -Schemas \<String[]>               | 要產生的實體類型的資料表結構描述。 如果省略這個參數，則會包含 所有結構描述。                                                                                                                                                             |
| -Tables \<String [] >              | 要產生的實體類型的資料表。 如果省略這個參數，則所有資料表都都包含在內。                                                                                                                                                                         |
...
| 參數                | 描述                                                                                                                                                                                                                |
|:-------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *-From* \<String>        | 在開始移轉。 移轉可能會識別，依名稱或識別碼。 數字 0 是特殊案例，這表示*第一個移轉之前，先*。 預設值為 0。                                                              |
| *-To* \<String>          | 結束的移轉。 預設為最後一個移轉。                                                                                                                                                                      |
...
| 參數                           | 描述                                                                                                                                                                                                                                                     |
|:------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <nobr>*-Migration* \<String></nobr> | 目標移轉。 移轉可能會識別，依名稱或識別碼。 數字 0 是特殊案例，這表示*第一個移轉之前，先*並造成所有移轉到還原作業。 如果未不指定任何移轉，則此命令預設的最後一個移轉。 |
